...
const MonthlyFootfall = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Fetch monthly footfall and conversion data
      const monthlyData = await fetchFootfallData(
        formattedStartDate,
        formattedEndDate,
        filters.location,
        MEASUREMENTS.MONTHLY.value
      );
      updateFootfallChartData(monthlyData);
      updateConversionChartData(monthlyData);
    } catch (error) {
  ...
  // Update the bar chart for footfall and bill count vs. month
  const updateFootfallChartData = (data) => {
    ...
    data.forEach((item) => {
      const monthLabel = item.MonthLabel || `${item.Year}-${item.Month}`;
  ...
  // Update the line chart for conversion rate vs. month
  ...
  return (
    <GridPanel className="" title="Monthly Footfall and Conversion Analysis">
      <div
        className={
        ...
        {loading ? (
          ...
          >
            ...
            <Chart
              ...
              title="Footfall and Bill Count by Month"
            />
...
export default MonthlyFootfall;
